...
public class ExecutorServiceExamplesLambdas {
	public static void main(String[] args) throws InterruptedException,
		...
		// lambda here now
		executorService.execute(() -> System.out.println("From ExecutorService") ); 
		...
		// lambda here now
		Future<?> future = executorService3.submit(() -> System.out.println("From executorService1") ); 
		...
		// lambda here now
		Future<String> futureFromCallable = executorService1.submit(()  -> {
			return "RESULT";
		} ); 
